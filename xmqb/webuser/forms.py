...
class ProfileForm(forms.ModelForm):
    ...
    department_choice = (
    (u'呼吸内科', u'呼吸内科'), (u'内分泌科', u'内分泌科'), (u'神经内科', u'神经内科'),
    (u'肾内科', u'肾内科'), (u'肝病研究所', u'肝病研究所'), (u'中医科', u'中医科'),
    (u'骨肿瘤科', u'骨肿瘤科'),(u'其他', u'其他'))
    ...
    department = forms.ChoiceField(label=u'职位', required=False, choices=department_choice)
