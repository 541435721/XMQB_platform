...
class ProfileForm(forms.ModelForm):
    position_choice = ((u'医师',u'医师'),(u'主任',u'主任'),(u'病人',u'病人'),(u'其他',u'其他'))

    department_choice = (
    (u'呼吸内科', u'呼吸内科'), (u'内分泌科', u'内分泌科'), (u'神经内科', u'神经内科'), (u'肾内科', u'肾内科'), (u'肝病研究所', u'肝病研究所'), (u'中医科', u'中医科'), (u'骨肿瘤科', u'骨肿瘤科'),(u'其他', u'其他'))
    ...
    department = forms.ChoiceField(label=u'科室',required=False,choices=department_choice)
...
class ChangePasswordForm(forms.Form):
    oldpassword=forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control','size': 30}),label=(u"原口令"),
                                max_length=300,required=True,error_messages={'required': u'请输入原始密码'})
    newpassword=forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control','size': 30}),label=(u"新口令"),
                                max_length=300,required=True,error_messages={'required': u'请输入新密码'})
    newpassword1 = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control', 'size': 30}), label=(u"新口令"),
