...
urlpatterns = [
    ...
    url(r'^download/(?P<path>.*)$',serve,{'document_root':settings.DOWNLOAD_DIR}),
    url(r'^admin_project/$', admin_views.admin_project, name='admin_project'),
    url(r'^admin_select_project/$', admin_views.admin_select_project, name='admin_select_project'),
    url(r'^handle_project/$', admin_views.handle_project, name='handle_project'),
    url(r'^admin_uploadify_script/$',admin_views.admin_uploadify_script,name='admin_uploadify_script'),
    url(r'^admin_project_complete/$',admin_views.admin_project_complete,name='admin_project_complete'),
    url(r'^cancle_complete/$',admin_views.cancle_complete,name='cancle_complete'),
